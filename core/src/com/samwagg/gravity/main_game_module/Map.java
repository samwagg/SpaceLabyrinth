        ...
        private void readMap() throws MapFormatException {
            ...
            for (int i = 0; i < strList.size(); i++) {
                ...
                for (int j = 0; j < lineArray.length; j++) {
                    switch (lineArray[j]) {
                        case 'x':
                            gameMap[i][j] = GameTile.WALL;
                            break;
                        case '>':
                            gameMap[i][j] = GameTile.FORCE_RIGHT;
                            break;
                        case '<':
                            gameMap[i][j] = GameTile.FORCE_LEFT;
                            break;
                        case '^':
                            gameMap[i][j] = GameTile.FORCE_UP;
                            break;
                        case '!':
                            gameMap[i][j] = GameTile.FORCE_DOWN;
                            break;
                        case '1':
                            gameMap[i][j] = GameTile.MOV_BLOCK1;
                            break;
                        case '2':
                            gameMap[i][j] = GameTile.MOV_BLOCK2;
                            break;
                        case '3':
                            gameMap[i][j] = GameTile.MOV_BLOCK3;
                            break;
                        case '4':
                            gameMap[i][j] = GameTile.MOV_BLOCK4;
                            break;
                        case '5':
                            gameMap[i][j] = GameTile.MOV_BLOCK5;
                            break;
                        case '6':
                            gameMap[i][j] = GameTile.MOV_BLOCK6;
                            break;
                        case '7':
                            gameMap[i][j] = GameTile.MOV_BLOCK7;
                            break;
                        case '8':
                            gameMap[i][j] = GameTile.MOV_BLOCK8;
                            break;
                        case '9':
                            gameMap[i][j] = GameTile.MOV_BLOCK9;
                            break;
                        case '-':
                            gameMap[i][j] = GameTile.END_RANGE;
                            break;
                        case '|':
                            gameMap[i][j] = GameTile.RANGE_VERT;
                            break;
                        case '#':
                            gameMap[i][j] = GameTile.RANGE_HOR;
                            break;
                        case 's':
                            gameMap[i][j] = GameTile.START;
                            break;
                        case 'e':
                            gameMap[i][j] = GameTile.END;
                            break;
                        case 'a':
                            gameMap[i][j] = GameTile.AI_START;
                            break;
                        default:
                            gameMap[i][j] = GameTile.EMPTY;
                    }
                }
            }
